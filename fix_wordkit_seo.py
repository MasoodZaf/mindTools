...
for filepath in html_files:
    ...
    # E.g., 'unscramble-tool.html' -> 'unscramble-tool'
    # E.g., "index.html" -> "/"
...
print("Generated new sitemap.xml")
